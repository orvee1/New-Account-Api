...
<div class="max-w-7xl mx-auto px-4 py-6">
  ...
  <form method="GET" action="{{ route('admin.companies.index') }}" class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-3">
      ...
      <tbody class="divide-y divide-gray-100">
        @forelse ($companies as $company)
          <tr class="text-sm">
            ...
            <td class="px-4 py-3">
              @if($company->logo_url)
                <img src="{{ $company->logo_url }}" alt="logo" class="h-8 w-8 rounded object-cover ring-1 ring-gray-200" />
              @else
